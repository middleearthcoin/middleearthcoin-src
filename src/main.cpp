...
uint256 hashGenesisBlock("0x00000000391142e8c7717f06d30e814c87c30e4b6c729bef605d5d730f43900a");
...
const string strMessageMagic = "MiddleEarthCoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000391142e8c7717f06d30e814c87c30e4b6c729bef605d5d730f43900a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1399028843;
        block.nBits    = 486604799;
        block.nNonce   = 1679239646;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MiddleEarthCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MiddleEarthCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("MiddleEarthCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running MiddleEarthCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("MiddleEarthCoinMiner terminated\n");
        throw;
    }
}
